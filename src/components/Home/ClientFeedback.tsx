...
const ClientFeedback = ({isActive, className, image, onClick}: IClientFeedbackProps) => {
  ...
  return (
    <article 
      ...
      className={cn(
        ...
        className,
        {'left-0 lg:left-0 z-10': isActive && (window.innerWidth < 667 || (refClient.current?.offsetLeft! > window.innerWidth / 2 && window.innerWidth < 1620))}
      )}
      style={{
