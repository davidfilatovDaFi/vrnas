  ...
  return (
    <section className="mb-[100px] md:mb-[150px]">
      <Container className="flex flex-col md:flex-row gap-[66px]">
        <div className="relative md:flex-[0_1_50%] md:h-[622px] flex-auto mx-auto h-[370px] w-[350px] extra_sm:h-[456px] extra_smw-[430px]">
        ...
        <div className="flex-[0_1_50%]">
          ...
          />
          <p className="text-[#D1D1D1] leading-[28px] mt-3">VRNas is a leading provider of VR services for education, entertainment, architecture, and events. Our mission is to bring the power of virtual reality to everyone, allowing them to explore new worlds, learn in new ways, and experience events in a whole new light.</p>
